...
{
    public class AfectiuniPageViewModel
    {
        public ObservableCollection<Afectiuni> AfectiuniList { get; set; }
        public AfectiuniPageViewModel()
        {
            AfectiuniList = new ObservableCollection<Afectiuni>();
            /*AfectiuniList.Add(new Afectiuni
            {
                Denumire = "",
                Descriere = "",
                Recomandari = "",
